...
export default function Services() {
  return (
    <section id="services" className="container mx-auto my-5 w-full mt-3" >
      <div className="text-center">
        <h1 className="text-3xl font-bold py-2 dark:text-white decoration-slice underline underline-offset-[5px] decoration-fuchsia-700" data-aos="fade-up">SERVICES</h1>
      ...
      <div className="mt-5 grid grid-cols-4 gap-10 max-lg:gap-3 max-sm:grid-cols-2 max-lg:grid-cols-3 max-lg:px-[3%] ">
        ...
        <div className="transition-all duration-300 hover:-translate-y-6 hover:text-fuchsia-600">
          <div className="bg-gray-50 dark:bg-gray-800 shadow shadow-fuchsia-700 p-5 rounded-xl border border-fuchsia-600" data-aos="fade-left" data-aos-delay="250">
            <BsCodeSlash size={28} />
        ...
        <div className="transition-all duration-300 hover:-translate-y-6 hover:text-fuchsia-600">
          <div className="bg-gray-50 dark:bg-gray-800 shadow shadow-fuchsia-700 p-5 rounded-xl border border-fuchsia-600" data-aos="fade-right" data-aos-delay="400">
            <MdDevices size={28} />
        ...
        <div className="transition-all duration-300 hover:-translate-y-6 hover:text-fuchsia-600">
          <div className="bg-gray-50 dark:bg-gray-800 shadow shadow-fuchsia-700 p-5 rounded-xl border border-fuchsia-600" data-aos="fade-left" data-aos-delay="400">
        ...
        <div className="transition-all duration-300 hover:-translate-y-6 hover:text-fuchsia-600">
          <div className="bg-gray-50 dark:bg-gray-800 shadow shadow-fuchsia-700 p-5 rounded-xl border border-fuchsia-600" data-aos="fade-right" data-aos-delay="250">
            <BsHeadset size={28} />
