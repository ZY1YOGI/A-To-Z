  ...
  return (
    <section id="about" className="container mx-auto my-16 overflow-hidden" >
      ...
      <div className="flex space-x-8 max-sm:block max-sm:space-y-8 max-sm:space-x-3">
        <div className="p-3 w-3/6 max-sm:w-full">
          ...
          <ul className="mt-5">
            <li className="flex space-x-1 transition-all duration-300 hover:-translate-y-1 text-gray-700 dark:text-gray-400 hover:font-bold hover:text-fuchsia-600 dark:hover:text-white cursor-default" data-aos="fade-left" data-aos-delay="150"><MdDoneAll size={25} /> <p>Ullamco laboris nisi ut aliquip ex ea commodo consequat</p> </li>
            <li className="flex space-x-1 transition-all duration-300 hover:-translate-y-1 text-gray-700 dark:text-gray-400 hover:font-bold hover:text-fuchsia-600 dark:hover:text-white cursor-default" data-aos="fade-left" data-aos-delay="350"><MdDoneAll size={25} /> <p>Duis aute irure dolor in reprehenderit in voluptate velit</p> </li>
            <li className="flex space-x-1 transition-all duration-300 hover:-translate-y-1 text-gray-700 dark:text-gray-400 hover:font-bold hover:text-fuchsia-600 dark:hover:text-white cursor-default" data-aos="fade-left" data-aos-delay="500"><MdDoneAll size={25} /> <p>Ullamco laboris nisi ut aliquip ex ea commodo consequat</p> </li>
          </ul>
        </div>
        ...
        <div className="p-3 w-3/6 max-sm:w-[93%] max-sm:px-0">
          ...
          <button className="dark:hover:bg-transparent hover:bg-gray-900  text-fuchsia-500 dark:bg-gray-800 dark:text-fuchsia-700 px-5 py-2 outline outline-2  outline-offset-1 rounded-3xl mt-5">
            Learn More
          </button>
        </div>
      </div>
