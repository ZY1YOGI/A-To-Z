      ...
      <nav className="navbar">
        ...
        <ul className="nav-links" data-aos="zoom-in">
          ...
          <li data-aos="fade-down"><Link className="nav-link" href="/categories">Categories</Link></li>
            <ul className="absolute hidden bg-gray-900 py-3 px-2 rounded-lg text-white dark:text-gray-700 top-8 left-7 group-hover:block outline outline-1 outline-offset-1 outline-red-700">
              <li><Link className="nav-link block" href="/categories/software">SoftWare</Link></li>
              <li><Link className="nav-link block" href="/categories/hardware">HardWare</Link></li>
              <li><Link className="nav-link block" href="/categories/pc">PC</Link></li>
              <li><Link className="nav-link block" href="/categories/printer">XPrinter</Link></li>
            </ul>
          </div>
